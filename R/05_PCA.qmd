...
Exploration of the trancripts data in PCA space
...
pca_meta_data <- function(to_plot) {
  plot_pca_ethnicity <- pca_fit |>
    ...
    labs(title = "PCA: Paitiens clusters by Trancriptpics",
...
We found that none of the metadata feature is explained in the PCA space

#### Plotting survival time to see an example of no correlation in PCA space
...
ggsave(filename = here("results/05_PCA_one_feature.png"),
...
plot_pca_one_feature_1 + plot_pca_one_feature_2 +  
  plot_pca_one_feature_3 + plot_pca_one_feature_4 + plot_layout(ncol = 2) 

combined<- plot_grid(plot_pca_one_feature_1,
